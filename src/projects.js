export const projects = [
        ...
        }, 
        {
            ...
            "description": "React Native social media app where users can come together and share their recommendations of movies/Tv shows they would like to watch with friends.",
            "technologies": "React Native, Ruby On Rails, PostgreSQL, OMDB API (Open Movie Database)"
        },
        {
            "img": "./images/cozyCabins.png", 
            "title": "Cozy Cabins", 
            "description": "Real Estate Application where users can list their homes for sale, and favorite other users listing for potential purchase.",
