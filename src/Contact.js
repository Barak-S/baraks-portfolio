    ...
    return(
        <div>
            ...
            <Col xs={12} sm={12} md={9} lg={9} className="profileCol" style={{color: "#191919", fontWeight: "600"}}>
                <p>I'm a creative individual with an entrepreneurial spirit, proficient at Web Application Development, using Git and modern web tools. With attention to detail, I take ideas, deliver quickly and consistently, and build things that provide a lot of value in a short amount of time.</p>
